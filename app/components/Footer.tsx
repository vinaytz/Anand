...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/dr-anand-shukla-59342838/",
    color: "#0A66C2",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/dranandkrshukla",
    color: "#E1306C",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/anand.shukla.73157",
    color: "#1877F2",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  return (
    <footer className="w-full bg-(--bg-light)">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <hr className="border-[#999] border-t" />
      </div>
