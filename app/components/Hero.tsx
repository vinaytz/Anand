    ...
    <section className="relative h-screen min-h-[800px] flex items-center overflow-hidden bg-rich-black">
      ...
      */}
      <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-[url('/gallery/public/Gemini_Generated_Image_505y02505y02505y.png')] scale-105 animate-slow-pan" />
