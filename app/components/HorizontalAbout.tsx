...
export default function HorizontalAbout() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-cream">
      ...
      <div className="absolute top-0 left-0 right-0 h-32 bg-linear-to-b from-rich-black to-transparent z-10 pointer-events-none" />
      ...
      >
        ...
        <div className="about-panel min-w-screen min-h-screen flex items-center justify-center px-6 lg:px-20 py-24 lg:py-0">
          <div className="max-w-5xl">
            ...
            <h2 className="panel-reveal text-[#1a1a1a] text-[clamp(2.8rem,7vw,7rem)] font-serif leading-[0.9] tracking-tight">
              A Bridge Between
              <br />
              <span className="italic text-gold-600">Wisdom</span> &{" "}
              <span className="italic text-gold-600">Action</span>
            </h2>
            <p className="panel-reveal text-[#555] text-lg lg:text-xl font-light leading-relaxed mt-10 max-w-xl">
            ...
            <div className="panel-reveal mt-10 flex items-center gap-3">
              ...
              <span className="text-[10px] tracking-[0.4em] uppercase text-[#999] font-medium">
                Keep scrolling →
              </span>
            </div>
          </div>
        ...
        <div className="about-panel min-w-screen min-h-screen flex items-center px-6 lg:px-20 py-24 lg:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            <div className="panel-reveal relative aspect-4/5 overflow-hidden bg-cream-dark">
              <img
                src="/gallery/1.png"
            ...
            <div>
              <blockquote className="panel-reveal text-2xl lg:text-[2.5rem] font-serif text-[#1a1a1a] leading-snug italic lg:leading-[1.2]">
              ...
              <div className="panel-reveal mt-8 flex items-center gap-4">
                ...
                <span className="text-[#888] text-sm tracking-wide">
                  Dr. Anand K Shukla
                </span>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
              {milestones.map((item) => (
                <div
                  key={item.year}
                  className="panel-reveal border-t-2 border-[#d5cec5] pt-8"
                >
                  <div className="text-gold-600 text-5xl lg:text-6xl font-serif mb-5">
                    {item.year}
                  </div>
                  <h3 className="text-[#1a1a1a] text-xl font-serif mb-3">
                    {item.title}
                  </h3>
        ...
        <div className="about-panel min-w-screen min-h-screen flex items-center justify-center px-6 lg:px-20 py-24 lg:py-0">
          <div className="text-center max-w-3xl">
            ...
            <h2 className="panel-reveal text-[#1a1a1a] text-4xl lg:text-6xl font-serif leading-tight mb-8">
              The Mission
            </h2>
            <p className="panel-reveal text-[#555] text-lg lg:text-2xl font-light leading-relaxed">
            ...
            <a
              href="/about"
              className="panel-reveal inline-flex items-center gap-3 mt-14 text-[10px] uppercase tracking-[0.3em] text-gold-600 font-bold border-b border-gold-400/50 pb-2 hover:text-[#1a1a1a] hover:border-[#1a1a1a] transition-colors duration-300"
            >
              Read Full Biography →
            </a>
          </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-linear-to-t from-rich-black to-transparent z-10 pointer-events-none" />
    </section>
  );
}
